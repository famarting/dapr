...
func init() {
	suite.Register(new(fanoutthreeschedule))
}

type fanoutthreeschedule struct {
...
func (f *fanoutthreeschedule) Setup(t *testing.T) []framework.Option {
...
func (f *fanoutthreeschedule) Run(t *testing.T, ctx context.Context) {
